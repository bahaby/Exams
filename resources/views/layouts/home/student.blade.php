    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <p>E-Class bir online sınav sistemidir. İstediğin zaman <b>Sınava Gir</b>'e bastığında sınava katılabilirsin. Geçmiş notlarını
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Öğrenci Bilgileri</h6>
          </div>
          <div class="card-body">
